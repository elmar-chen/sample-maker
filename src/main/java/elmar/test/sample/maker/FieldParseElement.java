...
@Data
public class FieldParseElement {
	...
	public static FieldParseElement from(Method field) {
		FieldParseElement parseElement = new FieldParseElement();
		parseElement.source = field;
	...
	public static FieldParseElement from(Class<?> clazz) {
		FieldParseElement parseElement = new FieldParseElement();
	...
	public static FieldParseElement fromTemplate(FieldParseElement parent, String subTemplate, int offset) {
		FieldParseElement parseElement = new FieldParseElement();
	...
	public List<FieldParseElement> getChildElements() throws ParseException {
	...
	public FieldParseElement getSlibing() {
		// TODO Auto-generated method stub
		return null;
	}
